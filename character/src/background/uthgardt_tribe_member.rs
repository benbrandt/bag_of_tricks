...
use super::{outlander::Outlander, Background, Personality, PersonalityOptions};
...
mod tests {
    ...
    fn test_snapshot() {
        ...
        let background = UthgardtTribeMember::gen(&mut rng, &Character::default());
    ...
    fn test_snapshot_display() {
        let mut rng = Pcg64::seed_from_u64(1);
        let (background, _personality) = UthgardtTribeMember::gen(&mut rng, &Character::default());
