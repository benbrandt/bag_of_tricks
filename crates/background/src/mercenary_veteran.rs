...
impl StartingEquipment for MercenaryVeteran {
    ...
    fn equipment(&self) -> Vec<Equipment> {
        vec![
            Equipment::new(Item::Other("an insignia of your rank".to_string()), 1),
...
mod tests {
    ...
    fn test_snapshot() {
        ...
        let background = MercenaryVeteran::gen(&mut rng, &AbilityScores::default(), &[], 2);
