...
impl Ethnicity {
    ...
    #[must_use]
    pub fn human_language(self) -> Option<&'static str> {
        match self {
            Self::Arkaiun => Some("Dambrathan (written in Espruar)"),
            Self::Barovian => None,
            Self::Bedine => Some("Midani"),
            Self::Calishite => Some("Alzhedo"),
            Self::Chondathan | Self::Tethyrian => Some("Chondothan"),
            Self::Damaran => Some("Damaran (written in Dethek)"),
            Self::Ffolk => Some("Waelan"),
            Self::Gur => Some("Guran (a patois of Roushoum and Rashemi)"),
            Self::Halruaan => Some("Halruaan (written in Draconic)"),
            Self::Illuskan => Some("Illuskan"),
            Self::Imaskari => Some("Roushoum"),
            Self::Mulan => Some("Chessentan, Mulhorandi, Untheric, or Thayan"),
            Self::Nar => Some("Damaran"),
            Self::Rashemi => Some("Rashemi"),
            Self::Shaaran => Some("Shaaran (written in Dethek)"),
            Self::Shou => Some("Shou"),
            Self::Tuigan => Some("Tuigan"),
            Self::Turami => Some("Turmic"),
            Self::Ulutiun => Some("Uluik"),
        }
    }
