...
pub const MONSTROUS_ORIGIN: &[&str] = &[
    ...
    "You received divine insight that sent you on your path, and occaisionally receive new visions that guide you.",
    ...
    "An injury or strange event caused you to lose all memory of your past, but occaisional flashes of it return to you.",
];
