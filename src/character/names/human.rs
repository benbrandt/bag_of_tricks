...
const CHONDATHAN: Names = Names {
    female: &[
        ...
        "Gardorra", "Gildha", "Halia", "Hesten", "Jelayne", "Jhessail", "Kerri", "Kharissa", "Kim",
        "Linene", "Lureene", "Maza", "Minghee", "Miri", "Mirna", "Mischka", "Moguhl", "Morwen",
        "Nestra", "Nilsa", "Ocheri", "Rowan", "Shandri", "Teresa", "Tessele", "Thalamra",
        "Thistle", "Tiarshe", "Tistyana", "Trilena", "Ylienna",
    ],
    male: &[
        "Aldith",
        "Alger",
